...
;;;;;;;;;;;;;;;;;;;;;;;;;; version that includes all the turtles data- including of the androids data-  in the AverageSpeed plot in the host screen ;;;;;;;;;;;;
...
to plot-cars
  ...
  if any? students [
    ...
    ;let yMin min [speed] of students
    plot yMin
    ...
    ;let yMax max [speed] of students
    plot yMax
...
;;;;;;;;;;;;;;;;;;;;;;;;;; version that includes just the students data in the AverageSpeed plot in the host screen ;;;;;;;;;;;;

; to plot-cars
;   if any? students [
;     set-current-plot "AverageSpeed"

;     ;; MinSpeed (students only)
;     set-current-plot-pen "MinSpeed"
;     let yMin min [speed] of students
;     plot yMin
;     record-avg-point avg_penB_name ticks yMin

;     ;; MaxSpeed (students only)
;     set-current-plot-pen "MaxSpeed"
;     let yMax max [speed] of students
;     plot yMax
;     record-avg-point avg_penA_name ticks yMax
...
;; THE VERSION OF THE DISTRIBUTION histogram:
...
;;;;;;;;;;;;;;;;;;;;; ADDED FOR "full data-row builders" ~ for "filling" the data if the columns of the logger_world_init_data_#.csv file ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
to csv-build-init-file
  ...
  csv-emit-patches
  csv-emit-links
  ;; DO NOT call csv-emit-plot-averagespeed here (no data yet)
end
